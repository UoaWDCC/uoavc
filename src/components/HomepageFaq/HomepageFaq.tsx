...
export default function HomepageFaq({ items }: HomepageFaqProps) {
  return (
    <section className="relative overflow-hidden bg-brand-white px-9 py-16 sm:px-8 xl:min-h-[820px] xl:px-0">
        ...
        <div className="xl:mx-auto xl:w-fit">
          ...
          <div className="grid gap-12 xl:grid-cols-[800px_257px] xl:gap-30">
            <div className="min-w-0">
              <div className="[&_[data-slot=accordion]]:!w-full [&_[data-slot=accordion]]:!gap-5 [&_[data-slot=accordion]]:!px-0 [&_[data-slot=accordion-trigger]]:!h-auto [&_[data-slot=accordion-trigger]]:!py-4 [&_[data-slot=accordion-content]_div]:break-words">
                <Faq items={items} />
              </div>
